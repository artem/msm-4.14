...
#define SONY_CAMERA_CMD_DOWNLOAD_FW    (SONY_CAMERA_CMD_BASE + 8)
#define SONY_CAMERA_CMD_GET_LOT_ID     (SONY_CAMERA_CMD_BASE + 9)
#define SONY_CAMERA_CMD_CLEAR          (SONY_CAMERA_CMD_BASE + 10)
#define SONY_CAMERA_CMD_BUG_ON         (SONY_CAMERA_CMD_BASE + 11)
